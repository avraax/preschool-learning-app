...
const GROUP_LABELS = {
  letters: 'Bogstaver', numbers: 'Tal', phrases: 'Sætninger',
  colours: 'Farver', mixed: 'Blandet', english: 'Engelsk',
};

function renderAuditMarkdown(doc) {
  ...
  lines.push('');
  lines.push('> AUTO-GENERATED by the `/audit` harness (dev-server `/api/audit-save`). Do not hand-edit —');
  lines.push('> re-run the harness. Source of truth: `narration-audit.json`.');
  lines.push('');
