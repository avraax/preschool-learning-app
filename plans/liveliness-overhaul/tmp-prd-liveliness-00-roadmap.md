...
> album). It re-skins and deepens what -01→-04 built — it does not change progression mechanics. Direction
> decided with the owner 2026-07-15: **"Structured World"** = A (lush, predictable) + B (a place you travel into).
> Baked soft-3D WebP art (no WebGL), generated by the owner in **Gemini** via the prompt appendix in that PRD.
> Ships as **one cohesive release**. Implement after -01→-04 are in.
